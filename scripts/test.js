...
const VerifyTestsResultStep = require('@kopytko/packager/src/step-runner/steps/verify-tests-result/verify-tests-result-step');
const verifyTestsResultStepConfig = require('@kopytko/packager/src/step-runner/steps/verify-tests-result/verify-tests-result-step-config');
